 ...
 */
public class PhoneUnlockEventHandler implements PyExtEventHandler {
    @Override
    public void onEvent(Device device, Script script, Map<String, String> map) {
        ...
        np.set("script_entrypoint", CapabilityType.ON_DEVICE_UNLOCK.getValue());
        device.sendPackage(np);
        Log.i("PyExt", "Sent ON_DEVICE_UNLOCK command to execute script with guid: " + script.getGuid());
    }
}
